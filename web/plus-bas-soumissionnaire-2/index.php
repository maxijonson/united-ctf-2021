HTTP/1.1 200 OK
Date: Sun, 19 Sep 2021 05:25:43 GMT
Server: Apache
...
Mark</td></tr></table></center>";
					...
					case "6":
						...
						break;
					case "7":
						echo "<h1>Welcome jeff</h1> <br><br><br><br><center><table border='2'><tr><td>3 new message(s): <hr>karl: Est-ce qu'ils ont bloqué ton mot de passe finalement?<hr>robert: STP passe au bureau lundi prochain.<hr>anonymous:</td></tr></table></center>";
						break;
					default:
						echo "<h1>Welcome {?}</h1>";
				}
